...
Button Admin_bt,Doctor_bt,Patient_bt,Emergency_bt,bloodbank_bt;
FirebaseUser user;
...
Button call,google,hospital;
    ...
    private void ButtonListener() {
        ...
        bloodbank_bt=findViewById(R.id.bloodbank);
        ...
        bloodbank_bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
