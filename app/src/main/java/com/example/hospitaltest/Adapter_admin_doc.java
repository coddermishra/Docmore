...
public class Adapter_admin_doc extends RecyclerView.Adapter<Adapter_admin_doc.ExampleViewHolder_hos> {
    ...
    public class ExampleViewHolder_hos extends RecyclerView.ViewHolder {
        ...
        public ExampleViewHolder_hos(View itemView) {
            ...
            mTextView3day = itemView.findViewById(R.id.textView40);
            mTextView4time= itemView.findViewById(R.id.textView41);
    ...
    public Adapter_admin_doc(ArrayList<item_Hospital> exampleList, Context context, LinkedHashMap<Integer,String> myhashMap) {
    ...
    public void onBindViewHolder(ExampleViewHolder_hos holder, int position) {
        ...
        holder.mTextView3day.setText("Days: "+currentItem.getHospital_address());
